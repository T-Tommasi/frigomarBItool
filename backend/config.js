...
function HARDCODED_ANOMALIES() {
  return {
    INTERNAL_PRODUCTION_NO_COST: {
      CA029: { UUID: "CA029", COST: 11 },
      SC022: { UUID: "SC022", COST: 2 },
      CA028: { UUID: "CA028", COST: 11 },
      GL030: { UUID: "GL030", COST: 10 },
      MN091: { UUID: "MN091", COST: 20 },
      PG013: { UUID: "PG013", COST: 30.53 },
      SP021: { UUID: "SP021", COST: 1.85 },
    },
    ERRONEOUS_UUID_USED: {
      BR014: {
        UUID: "BR014",
        ANOMALY_TEXT:
          "ID prodotto utilizzato per indicare altre tipologie di merce",
      },
      RI008: {
        UUID: "RI008",
        ANOMALY_TEXT:
      ...
      SC002: {
        UUID: "SC002",
        ANOMALY_TEXT:
          "ID prodotto utilizzato pre indicare altre tipologie di merce",
      },
    },
    UNKNOWN_PRICE_ANOMALY: {
      PG018: {
        UUID: "PG018",
        ANOMALY_TEXT: "Errore sconosciuto nel calcolo marginalità",
      },
    },
  };
}
